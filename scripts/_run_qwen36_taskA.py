...
# Adjust if your GPU memory is different
MAX_MEMORY = {
    0: "75GiB",
    1: "75GiB",
    2: "75GiB",
...
- image_reliance, clinical_reliance, and rna_reliance must be between 0 and 1.
...
def call_model(row, variant, max_retries=4):
    ...
    for attempt in range(max_retries):
        try:
            ...
            print(
                f"\n[CUDA OOM Retry] case={row.get('case_barcode')} "
