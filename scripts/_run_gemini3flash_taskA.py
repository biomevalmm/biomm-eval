...
def parse_prediction_response(response_text):
    ...
    try:
        return TaskAPrediction.model_validate_json(text).model_dump()
    except Exception:
        pass
    ...
    if start >= 0 and end > start:
        ...
        obj["image_reliance"] = safe_float01(obj.get("image_reliance", 0))
        obj["clinical_reliance"] = safe_float01(obj.get("clinical_reliance", 0))
        obj["rna_reliance"] = safe_float01(obj.get("rna_reliance", 0))
...
def call_model_once(row, variant):
    ...
    response = client.models.generate_content(
        ...
        config=types.GenerateContentConfig(
            ...
            response_json_schema=TaskAPrediction.model_json_schema(),
